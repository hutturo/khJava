...
public class F_Triple {
	 ...
	 *  * 삼항 연산자 : 항목이 3개인 연산자
	 *  
	 *  [표현법] 조건식 ? 조건식이 true일 경우의 결과값1 : 조건식이 false일 경우의 결과값2
	 *  
...
//		System.out.println(num > 0 ? "양수" : "양수가 아님");
	...
	public void method2() {
		/*
		 *  사용자에게 두개의 정수값 입력받아서
		 *  두 정수값의 곱셈결과가 100보다 큰 경우 "결과가 100이상입니다."
		...
		System.out.println(num1 * num2 + "는(은) " + result);
...
//		String result = num % 2 == 1 ? "홀수 입니다." : "짝수 입니다.";
		String result = num % 2 != 1 ? "짝수 입니다." : "홀수 입니다.";
...
//		String result = (num > 0 ? "양수이다." : (num == 0 ? "0 이다." : "음수이다."));
