...
public class B_InDecrease {
	...
	public void method1() {
		...
		System.out.println("전위연산 적용 후 num2의 값 : " + num2); // num2 = 12 출력
	...
	public void method5() {
		...
		System.out.println(++a - --b); // a=11 b=9	=> 2 출력
		System.out.println(--b + c++); // b=8 c=20(21) => 28 출력
		System.out.println(a++ + b-- * c++); // a=11(12) b=8(7) c=21(22) => 179 출력
