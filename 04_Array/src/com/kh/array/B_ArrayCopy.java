...
public class B_ArrayCopy {
	...
	public void method1() {
		...
		// 조소값만을 복사(얕은복사)했을 때 같은 배열을 참조하고 있음
...
//		System.arraycopy(원본배열명, 복사를 시작할 인덱스, 복사본배열명, 복사본배열의 복사가 시작될 시작인덱스, 복사할갯수);		
		...
		System.out.println();
		System.out.println("orgin의 주소값 : " + origin.hashCode());
