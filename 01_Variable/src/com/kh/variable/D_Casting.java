...
public class D_Casting {
	 ...
	 *    
	 * * 주의사항
	 * boolean은 형변환이 불가!! 오로지 true/false의 값 만을 가질 수 있음
	 */
	...
	public void casting2() {
		// 강제형변환 : 큰 크기의 자료형을 작은 크기의 자료형으로 바꾸는 과정
		...
		// 해결방법1. 연산결과값을 int형으로 강제형변환 해준 뒤 담기
		int iSum = (int)(iNum + dNum); // 강제형변환하게 되면 소수점 아래부분은 버려버림 (데이터 손실 발생!)
		System.out.println("iSum : " + iSum);
		
		// 해결방법2. double형을 int형으로 강제형변화 한 후 덧셈연사되게
